...
mod chip {
    ...
    use rand_zkvm::tables::sha256::{self, col, sha256_trace, Sha256Event, BLOCK};
    ...
    fn sha256_trace_write_backs_match_the_reference_on_a_thousand_blocks() {
        ...
        for (i, e) in events.iter().enumerate() {
            ...
            let mut want = e.h_in;
            rand_zkvm::sha256::compress(&mut want, &e.block);
            for k in 0..8 {
    ...
    fn sha256_padding_blocks_are_honest_zero_compressions_with_zero_counts() {
        ...
        let mut want = [0u32; 8];
        rand_zkvm::sha256::compress(&mut want, &[0u32; 16]);
        for k in 0..8 {
...
mod harness {
    ...
    use rand_zkvm::tables::sha256::{col, sha256_trace, Sha256Air, Sha256Event, BLOCK};
    ...
    fn the_chips_memory_sends_are_the_emulators_own_recorded_accesses() {
        ...
        use rand_zkvm::emulator::{execute, Syscall};
        use rand_zkvm::isa::REG_ZERO;
        use rand_zkvm::sha256::IV;
