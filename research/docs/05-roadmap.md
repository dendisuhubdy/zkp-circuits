...
7. **M4.3's ERC-20 `transfer` proves at tier 18, not the plan's ≤ 16 (spec
   ...
   soundness property,
   and the measured cost is 121 630 executed cycles (126 357 with the program-
   ...
   fixed overhead, 6 334 decoding the two witnesses, and 4 727 in the two digest
   prefixes. Local levers already took it from 224 212 total cycles to 126 357
   ...
   call through the same binary at tier 16 (776 KB, 421 s to prove). It is also the
